 ...
 * Rebecca Dovi 
 * 
 * who the heck is "Rebecca Dovi"? - miryokuu
 */
import java.io.*;
import java.util.*;

class S2_L14 // rename to Main!
{
    /*
     * Returns the number of Strings in the input list that start with the given
     * letter. Implementation should use linear search, and ignore the case of the
     * input letter.
     */
    public static int countLetter(ArrayList<String> list, String letter)
    {
        ...
        for (String str : list)
        {
            count += str.length() - str.replace(letter.toUpperCase(), "").length();
        }
    ...
    public static void main(String str[]) throws IOException
    {
        ...
        /*
         * Print the output from calling countLetter with various letters. For example,
         * countLetter (zoo, "e") should return 2 while countLetter(zoo, "W") should
         * return 0.
         */
