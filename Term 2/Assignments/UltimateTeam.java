...
public class UltimateTeam {
    ...
    /**
     * Returns a String listing all the UltimateTeams's UltimatePlayers that have the position of “cutter”. 
     * Returns an empty String if the UltimateTeam does not have a player with the position of “cutter”. 
    ...
    /**
     * Returns a String listing all the UltimateTeams's UltimatePlayers that have the position of “handler”.
     * Returns an empty String if the UltimateTeam does not have a player with the position of “handler”. 
     * See the Sample Run below for the format of the returned String.
     * 
     * @retun String
     */
    ...
    /**
     * Returns a multiline String listing the Coaches and UltimatePlayers on the UltimateTeam. 
