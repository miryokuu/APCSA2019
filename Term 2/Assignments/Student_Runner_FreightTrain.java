public class Student_Runner_FreightTrain {
    ...
    public static void main(String[] args)
    {
        ...
        // trainWithFiveCars currently has all cars carrying gizmos. Change them to
        // gadgets
        trainWithFiveCars.setCargo("gadgets");
        System.out.println("Printing trainWithFiveCars with cargo now gadgets:\n" + trainWithFiveCars + "\n");
        // now set trainWithFiveCars to cargo of "onions". Since this is invalid, it
        // should set the cargo back to gizmos.
        trainWithFiveCars.setCargo("onions");
        System.out.println(
                "Printing trainWithFiveCars with cargo of onions (back to gizmos):\n" + trainWithFiveCars + "\n"
        );
        ...
        // Let's make a train of length 8, setMultiCargo on it, and make sure the cargo
        // type alternates appropriately
