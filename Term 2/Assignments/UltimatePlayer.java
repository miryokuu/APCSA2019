...
public class UltimatePlayer extends Person {
    ...
    /**
     * Constructor that accepts the first name, last name and the position of a player. 
     * The first and last names should be set by calling the constructor of the parent class. 
     * Position should be set to “handler” if the input string is not “handler” or “cutter”. 
     * The UltimatePlayer constructor also sets the jersey number to the next available positive integer.
     * The first UltimatePlayer created should have a jersey number of 1, 
     * the second will have a jersey number of 2, third of 3, etc.
     */
