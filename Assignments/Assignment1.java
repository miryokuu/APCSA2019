...
class Assignment1 {
    ...
    public static void main(String[] args) {
        ...
        avgWebRating = (double)(((double)rateReviewWeb[0] + (double)rateReviewWeb[1] + (double)rateReviewWeb[2]) / 3);
        ...
        // System.out.println(String.format(TEMPLATE_STRING, avgWebRating, avgFGroupRating, avgCrtRating, (avgWebRating*0.20)+(avgFGroupRating*0.30)+(0.5*avgCrtRating)));
        // WHY IS THIS BROKEN
        ...
        System.out.println( "Average website rating: " + avgWebRating 
                ...
                + "\nOverall movie rating: " + ((avgWebRating*0.20)+(avgFGroupRating*0.30)+(0.5*avgCrtRating)));
        input.close();
    }
}