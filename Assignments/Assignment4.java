...
public class Assignment4 {
    public static void main(String[] args)
    {
    	...
    	for (String indexString : inputString.toLowerCase().split(" "))
    	{
            ...
            while (tempString.substring(1).indexOf("a") != -1 || 
                    tempString.substring(1).indexOf("e") != -1 ||
                    tempString.substring(1).indexOf("i") != -1 || 
                    tempString.substring(1).indexOf("o") != -1 ||
                    tempString.substring(1).indexOf("u") != -1) 
            {
    	...
    	System.out.println(String.format("Shortened message: %s\nRepeated letters removed: %d\nVowels removed: %d\nTotal characters saved: %d", 
